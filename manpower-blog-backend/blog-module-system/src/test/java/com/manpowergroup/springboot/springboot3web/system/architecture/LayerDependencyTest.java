package com.manpowergroup.springboot.springboot3web.system.architecture;
...
class LayerDependencyTest {
    ...
    private static final String DOMAIN = "..system.domain..";
    private static final String APPLICATION = "..system.application..";
    private static final String INFRASTRUCTURE = "..system.infrastructure..";
    private static final String FRAMEWORK = "..springboot3web.framework..";
    private static final String MAPPER = "..system.infrastructure.persistence.mapper..";

    private static final JavaClasses CLASSES = new ClassFileImporter()
            .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
            .importPackages("com.manpowergroup.springboot.springboot3web.system");
